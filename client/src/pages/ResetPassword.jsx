...
const ResetPassword = () => {
    ...
    axios.create.baseURL = 'https://mern-auth-fronend.vercel.app/api'
                    ...
                    <div className="flex justify-between mb-8" onPaste={handlePaste}>
                        {
                            Array(6).fill(0).map((_, index) => (
                                <input className="w-12 h-12 bg-[#333A5C] text-white text-center text-lg rounded-md" type="text" maxLength="1" key={index} required ref={e => inputRefs.current[index] = e}
